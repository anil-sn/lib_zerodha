...
from ..models.base import Order, Trade, GTTTrigger, MFHolding
from ..models.portfolio import Position, Holding, MarginInfo
from ..exceptions.api_exceptions import LibZerodhaError
...
class TradingDatabase:
    ...
    def _get_connection(self):
        ...
        try:
            ...
            raise LibZerodhaError(f"Database operation failed: {e}")
...
def create_sqlite_storage(db_path: Optional[str] = None) -> TradingDatabase:
    ...
    Returns:
        TradingDatabase instance configured for SQLite storage.
    """
    if db_path is None:
        db_path = ":memory:"
